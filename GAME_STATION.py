...
dark_mode = Image.open("game_station_assets/dark_mode.png").resize((30, 30))
dark_mode_tk = ImageTk.PhotoImage(dark_mode)

light_mode = Image.open("game_station_assets/light_mode.png").resize((30, 30))
light_mode_tk = ImageTk.PhotoImage(light_mode)

def change_mode():
    if window._get_appearance_mode() == 'light':
        set_appearance_mode('dark')
        appearance_mode_button.configure(image = light_mode_tk)
    else:
        set_appearance_mode('light')
        appearance_mode_button.configure(image = dark_mode_tk)

appearance_mode_button = CTkButton(window, 
                                   image = light_mode_tk,
                                   ...
                                   height = 50,
                                   command = change_mode)
appearance_mode_button.place(relx = 0.8, rely = 0.04)
...
game_frame.place(relx = game_frame_x, rely = 0.65)
